...
void DetectDist () {
  ...
  if ((cm < detectSet2) & (cm > detectSet1)) {
    if (flag == 0) {
      //String dist = String("102|2|TRUE|"+(String)cm);
      String dist = "102|2|TRUE";
    ...
    if (flag == 1) {
      //String dist = String("102|2|FALSE|"+(String)cm);
      String dist = "102|2|FALSE";
      dist.toCharArray(msg, 32);
      radio.stopListening();
      radio.openWritingPipe(USC);
      Serial.println(dist);
